...
\gtodo{Add plot of time complexity and error.}
...
\gtodo{Add Plot of time complexity and error for $N$.}
...
\begin{Figure}
   \begin{center}
     \input{figures/cholesky_err.tikz}
   \end{center}
   \captionof{figure}{Error of Cholesky method.}\label{fig:ch_err}
\end{Figure}
